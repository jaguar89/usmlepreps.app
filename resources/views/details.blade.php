        ...
        @foreach($tests as $test)
            <div class="expandable-section p-4 bg-white shadow rounded mb-4" id="title-{{$test->title}}">
                ...
                <div id="section{{ $loop->index }}" class="hidden flex flex-col space-y-4">
                    ...
                    <div
                        class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 space-x-0 sm:space-x-2 justify-between items-center">
                        <div
                        ...
                        <a
                            ...
                            class="bg-green-500 w-full sm:w-auto text-center hover:bg-green-400 text-white font-bold py-1 px-2 border-b-2 border-green-700 hover:border-green-500 rounded text-xs sm:text-sm flex items-center justify-center"
                        >
